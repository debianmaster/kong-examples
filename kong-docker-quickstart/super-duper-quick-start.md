...
curl -X POST http://admin.kong.zelarsoft.com:8001/services -d name=admin -d url=http://localhost:8001 -H "Kong-Admin-Token: changeme"
curl -X POST http://admin.kong.zelarsoft.com:8001/services -d name=manager -d url=http://localhost:8002 -H "Kong-Admin-Token: changeme"
curl -X POST http://admin.kong.zelarsoft.com:8001/services -d name=portal -d url=http://localhost:8003 -H "Kong-Admin-Token: changeme"
curl -X POST http://admin.kong.zelarsoft.com:8001/services -d name=portalapi -d url=http://localhost:8004 -H "Kong-Admin-Token: changeme"
curl -X POST http://admin.kong.zelarsoft.com:8001/services/admin/routes -d hosts=admin.kong.zelarsoft.com -H "Kong-Admin-Token: changeme"
curl -X POST http://admin.kong.zelarsoft.com:8001/services/manager/routes -d hosts=manager.kong.zelarsoft.com -H "Kong-Admin-Token: changeme"
curl -X POST http://admin.kong.zelarsoft.com:8001/services/portal/routes -d hosts=portal.kong.zelarsoft.com -H "Kong-Admin-Token: changeme"
curl -X POST http://admin.kong.zelarsoft.com:8001/services/portalapi/routes -d hosts=portalapi.kong.zelarsoft.com -H "Kong-Admin-Token: changeme"
